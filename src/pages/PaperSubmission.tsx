      ...
      <div className="container mx-auto px-4 py-12 flex-grow">
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
          ...
          <ol className="list-decimal pl-6 space-y-4 font-graphik">
            ...
            <li className="font-graphik">
              All papers must be submitted online via <Link to={"https://cmt3.research.microsoft.com/ICI3T2026"} className='text-blue-700 underline'>Microsoft CMT Submission Portal</Link>.
            </li>
            <li className="font-graphik">
