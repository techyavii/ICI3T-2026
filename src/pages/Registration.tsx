        ...
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
          ...
          <section className="mb-10">
            ...
            <div className="mt-4 text-sm text-gray-600">
              ...
              <p className="text-justify">If you have any concerns regarding the registration policy or fees please feel free to write us at <a href="mailto:ici3t.congress@gmail.com" className="text-blue-600 hover:underline">ici3t.congress@gmail.com</a> .</p>
            </div>
          </section>
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-4">
              <Card>
                <CardContent className="flex flex-col items-center justify-center p-6">
                  ...
                  <Link to="https://buy.stripe.com/cNifZjcHo6kM3u8bdP0000v"><Button className="mt-2 bg-[#001324] hover:bg-[#333333]">Pay with Stripe</Button></Link>
              ...
              <Card>
                <CardContent className="flex flex-col items-center justify-center p-6">
                  ...
                  <a href='https://rzp.io/rzp/Qy49KvRk'><Button className="mt-2 bg-[#001324] hover:bg-[#333333]">Pay with Razorpay</Button></a>
